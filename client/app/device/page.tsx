          ...
          <div className="space-y-6 ">
            ...
            <div>
              ...
              <input
                ...
                maxLength={9}
                className="bg-zinc-900 w-full px-4 py-3 border-2 border-dashed border-zinc-700 rounded-lg text-foreground placeholder-muted-foreground focus:outline-none focus:border-zinc-600 font-mono text-center text-lg tracking-widest"
              />
            ...
            {/* Error Message */}
            {error && (
              <div className="border bg-red-950 border-red-900 rounded-lg p-3 text-red-200 text-sm ">
                my error
              </div>
            )}
            ...
            <div className="p-4 bg-zinc-900 border-2 border-dashed border-zinc-700 rounded-lg">
              <p className="text-xs text-muted-foreground leading-relaxed">
                This code is unique to your device and will expire shortly. Kep
